...
Note this bootcamp **is NOT a training on statistics** but rather a training on how to use R to perform different tasks.

You will need your own laptop and must install <a href="https://www.r-project.org/">R  language</a> and <a href="https://posit.co/downloads/">Posit (aka RStudio)</a> prior to training, follow the instructions on their websites. We recommend to first download R and then Posit. 
