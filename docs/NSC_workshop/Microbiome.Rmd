...
library(pacman)
p_load(tidyverse, dada2, decontam, phyloseq, Biostrings)
# I always set a seed in case any of my functions rely on random values and i want reproducibility.
set.seed(3618)
```
### Download data

Download the raw fastqs and metadata here: https://biox.unr.edu/ftp/NSC_workshop/ , unzip, and put in your project folder 
